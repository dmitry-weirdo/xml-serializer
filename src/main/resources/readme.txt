...
Файл настроек xmlSerializer.properties должен находится строго в директории запуска и называться именно так.
...
Мавеновская сборка и запуск тестов будут работать, если установить в локальный репозиторий kefir (модули kefir-util и kefir-gen). Как их описывать - можно понять по pom.xml.
